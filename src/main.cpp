...
uint256 hashGenesisBlock("0xb70e907309ec11c7559e743c95e4c884ca621930f8e03cb5bc8b13d3b24d219c");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa3257872f0697f27e9512531ac421126a3984f44a4f4c5d9009bc08af041399a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Hello Tian";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1530107225;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085723192;

        if (fTestNet)
        {
            block.nTime    = 1530107225;
            block.nNonce   = 386121892;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xeea057481ec406c9903a5027800d77cc0d209ce3a2093357e2e78208d408158c"));
        block.print();
